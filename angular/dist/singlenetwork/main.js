...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.doRegister = function (formData) {
        ...
        return new Promise(function (resolve, reject) {
            firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"]().createUserWithEmailAndPassword(formData.email, formData.password)
                .then(function (res) {
                resolve(res);
                var user = new _entity_user_user__WEBPACK_IMPORTED_MODULE_7__["User"](formData.username, formData.email);
                var date = new Date();
    ...
    AuthService.prototype.doSocialLoginRegister = function (firebaseUser) {
        var userEntity = new _entity_user_user__WEBPACK_IMPORTED_MODULE_7__["User"](firebaseUser.displayName, firebaseUser.email);
        var date = new Date();
        date.setUTCFullYear(2019, 0, 1);
...
var MyProfileComponent = /** @class */ (function () {
    ...
    MyProfileComponent.prototype.deactivateAccount = function () {
        ...
        if (this.warningCount >= 3 && this.accountIsCompleted()) {
            ...
            this.ufbs.setStorage(user);
            var str = user.isActivated ? "aktiveret." : "deaktiveret.";
