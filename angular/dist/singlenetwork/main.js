...
var AppNavbarComponent = /** @class */ (function () {
    function AppNavbarComponent(authService) {
        ...
        this.menuFields = [{ 'displayName': "dashboard", 'link': "/loggedin-dashboard" },
...
/* harmony import */ var _mobile_login_header_mobile_login_header_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../mobile-login-header/mobile-login-header.component */ "./src/app/mobile-login-header/mobile-login-header.component.ts");
...
var CreateAccountFormComponent = /** @class */ (function () {
    ...
    CreateAccountFormComponent.prototype.tryRegister = function (value) {
        ...
        this.authService.doRegister(value)
            .then(function (res) {
            _this.ufbs.insertUser(new _entity_user_user__WEBPACK_IMPORTED_MODULE_4__["User"](value.username, value.email));
            _this.spinner.hide();
            //this.errorMessage = "";
    ...
    CreateAccountFormComponent.prototype.openDialog = function () {
        var dialogRef = this.dialog.open(_mobile_login_header_mobile_login_header_component__WEBPACK_IMPORTED_MODULE_6__["MobileLoginHeaderComponent"], {
            width: '250px',
        });
    ...
    CreateAccountFormComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _user_firebase_service__WEBPACK_IMPORTED_MODULE_3__["UserFirebaseService"],
            _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialog"], ngx_spinner__WEBPACK_IMPORTED_MODULE_7__["NgxSpinnerService"]])
...
var CreateNewEventComponent = /** @class */ (function () {
    function CreateNewEventComponent(efbs, authService, ufbs, dialogRef, data, _formBuilder) {
        this.efbs = efbs;
        this.authService = authService;
        this.ufbs = ufbs;
        ...
        this.eventForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
            eventName: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            ...
            eventStartTime: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventEndTime: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventCategory: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventTargetGroup: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventMinAge: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventMaxAge: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventFile: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventHostRating: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventMinGuests: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventMaxGuests: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventGender: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventQueue: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventLocationStreet: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventLocationCity: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventLocationZip: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventDeadlineDate: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventDeadlineTime: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventPrice: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventPaymentOption: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventPaymentDue: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            eventPaymentDate: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
        });
    }
    ...
    CreateNewEventComponent.prototype.onSubmitEvent = function (value) {
        var e = this.formDataToModel(value);
        this.efbs.insertEvent(e);
    };
    CreateNewEventComponent.prototype.formDataToModel = function (formData) {
        var event = new _entity_event_event_model__WEBPACK_IMPORTED_MODULE_2__["Event"]();
        event.address = new _entity_helper_EventAddress__WEBPACK_IMPORTED_MODULE_3__["EventAddress"](formData.eventLocationStreet, formData.eventLocationCity, formData.eventLocationZip);
    ...
    CreateNewEventComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_event_firebase_service__WEBPACK_IMPORTED_MODULE_4__["EventFirebaseService"], _auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"],
            ...
            _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialogRef"], Object, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]])
...
var EventFilterComponent = /** @class */ (function () {
    function EventFilterComponent() {
        ...
        this.options = [{ value: 'onlyMen', displayValue: 'Kun for mænd' },
...
var EventFirebaseService = /** @class */ (function () {
    function EventFirebaseService(afAuth, db) {
        ...
        this.testMail = "ramonariley@equitax.com";
    }
    ...
    EventFirebaseService.prototype.getEventByKey = function (key) {
        var _this = this;
        var path = this.dbPath + key;
        this.db.object(path).valueChanges().subscribe(function (data) {
            _this.event = _this.jsonToObj(JSON.stringify(data));
        });
    };
    EventFirebaseService.prototype.getEventsByHost = function (hostMail) {
        var _this = this;
        var path = this.dbPath;
        return this.db.list(path, function (ref) { return ref.orderByChild('host').equalTo(_this.testMail); }).valueChanges();
    };
...
var EventListComponent = /** @class */ (function () {
    function EventListComponent(efbs, mds, spinner) {
        var _this = this;
        this.efbs = efbs;
        this.mds = mds;
        this.spinner = spinner;
        ...
        this.displayedColumns = ['name', 'address', 'distance', 'genderRatio', 'targetGroup', 'available'];
...
var FeedbackComponent = /** @class */ (function () {
    function FeedbackComponent(mds) {
        this.mds = mds;
        this.isMobile = false;
        this.storyForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            email: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            story: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('')
        });
        this.proposalForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            email: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            subject: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
...
var LandingPageHeaderComponent = /** @class */ (function () {
    function LandingPageHeaderComponent(authService, dialog, mds, spinner) {
        this.authService = authService;
        this.dialog = dialog;
        this.mds = mds;
        this.spinner = spinner;
...
var LandingPageComponent = /** @class */ (function () {
    function LandingPageComponent(spinner) {
        this.spinner = spinner;
    }
...
var LoggedinDashboardComponent = /** @class */ (function () {
    function LoggedinDashboardComponent(ufbs, authService) {
        this.ufbs = ufbs;
        this.authService = authService;
        this.isMobile = false;
        this.tiles = [
...
var MyProfileComponent = /** @class */ (function () {
    function MyProfileComponent(ufbs, authService, mds) {
        ...
        this.authService = authService;
        this.mds = mds;
        this.activationError = "Profilen er ikke aktiv. Udfyld alle obligatoriske felter for at aktivere.";
...
module.exports = __webpack_require__(/*! D:\Projects\Angular\singlenetwork\src\main.ts */"./src/main.ts");
