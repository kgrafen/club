...
// Tested: Yes
exports.afterEventAttendeeMail = functions.https.onRequest((request, response) => __awaiter(this, void 0, void 0, function* () {
    response.setHeader("Access-Control-Allow-Origin", "*");
    response.setHeader("Access-Control-Allow-Credentials", "true");
    response.setHeader("Access-Control-Allow-Methods", "GET,HEAD,OPTIONS,POST,PUT");
    response.setHeader("Access-Control-Allow-Headers", "Access-Control-Allow-Headers, Origin,Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers");
...
// Tested: No
exports.eventDeletedNotification = functions.database.ref('/events/{eventId}').onDelete((snapshot) => {
...
// Tested: Yes
exports.eventReminderShort = functions.https.onRequest((request, response) => __awaiter(this, void 0, void 0, function* () {
    response.setHeader("Access-Control-Allow-Origin", "*");
    response.setHeader("Access-Control-Allow-Credentials", "true");
    response.setHeader("Access-Control-Allow-Methods", "GET,HEAD,OPTIONS,POST,PUT");
    response.setHeader("Access-Control-Allow-Headers", "Access-Control-Allow-Headers, Origin,Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers");
    admin.database().ref('/events').once('value').then(snapshots => {
        snapshots.forEach(snapshot => {
            if (snapshot.val().shortReminderSent === undefined) {
                ...
                let dateStr = snapshot.val().dateStart;
...
// Tested: No
exports.eventReminderLong = functions.https.onRequest((request, response) => __awaiter(this, void 0, void 0, function* () {
    response.setHeader("Access-Control-Allow-Origin", "*");
    response.setHeader("Access-Control-Allow-Credentials", "true");
    response.setHeader("Access-Control-Allow-Methods", "GET,HEAD,OPTIONS,POST,PUT");
    response.setHeader("Access-Control-Allow-Headers", "Access-Control-Allow-Headers, Origin,Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers");
...
// Tested: No
exports.findAndChooseMonthlyJumper = functions.https.onRequest((request, response) => __awaiter(this, void 0, void 0, function* () {
    response.setHeader("Access-Control-Allow-Origin", "*");
    response.setHeader("Access-Control-Allow-Credentials", "true");
    response.setHeader("Access-Control-Allow-Methods", "GET,HEAD,OPTIONS,POST,PUT");
    response.setHeader("Access-Control-Allow-Headers", "Access-Control-Allow-Headers, Origin,Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers");
...
function getAverageScoreFromEvent(eKey) {
    return __awaiter(this, void 0, void 0, function* () {
        let score = -1;
        let count = 0;
        let goBwah = yield Promise.resolve(admin.database().ref("/ratings").orderByChild('fk_event').equalTo(eKey).once('value').then(snapshots => {
            snapshots.forEach(snapshot => {
...
function getNumberOfEvents(uid) {
    return __awaiter(this, void 0, void 0, function* () {
        let count = 0;
        let goBwah = yield Promise.resolve(admin.database().ref('/events').orderByChild('host').equalTo(uid).once('value').then(snapshots => {
            snapshots.forEach(snapshot => {
                count++;
                return true;
            });
...
function getUserScore(uid) {
    return __awaiter(this, void 0, void 0, function* () {
        let score = 0;
        let count = 0;
        let goBwah = yield Promise.resolve(admin.database().ref("/ratings").orderByChild('fk_host').equalTo(uid).once('value').then(snapshots => {
            snapshots.forEach(snapshot => {
                score += snapshot.val().score;
                count++;
                return true;
